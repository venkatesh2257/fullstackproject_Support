...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['purchase_subscription'])) {
    ...
    $plans = [
        1 => ['name' => 'Basic Merchant Plan', 'price' => 49.99, 'duration' => 30, 'type' => 'merchant'],
        2 => ['name' => 'Premium Merchant Plan', 'price' => 99.99, 'duration' => 60, 'type' => 'merchant'],
        3 => ['name' => 'Annual Merchant Plan', 'price' => 399.99, 'duration' => 365, 'type' => 'merchant']
    ];
...
<head>
    ...
    <title>Merchant Subscription - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="container">
        <h1>Merchant Subscription Plans</h1>
            ...
            <div class="plans-grid">
                <div class="plan-card">
                    ...
                    <ul class="plan-features">
                        ...
                        <li>View your product status</li>
                    </ul>
                    <form method="POST">
